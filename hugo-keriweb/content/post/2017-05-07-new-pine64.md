...
{{< postfig src="box.jpg" title="Box" width="360px" >}}
{{< postfig src="board.jpg" title="Board" width="360px" >}}

## セットアップ

### 採用したOS

{{< postfig src="ubuntu.png" title="Ubuntu" width="360px" >}}
...
{{< postfig src="keri.png" title="KERI" width="360px" >}}
