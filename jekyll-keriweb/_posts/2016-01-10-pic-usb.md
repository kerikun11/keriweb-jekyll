...
![AE-FT232](/images/2016-01-10-pic-usb/FT232.jpg)

## ハードウェアについて

PIC18F27J53を使用します。

![PIC18F27J53](/images/2016-01-10-pic-usb/view.jpg)
...
これらのファイルは[ここ](/images/2016-01-10-pic-usb/USB_CDC.zip)からダウンロードできます。
...
![プロジェクトのプロパティ](/images/2016-01-10-pic-usb/p1.png)
![プロジェクトのプロパティ](/images/2016-01-10-pic-usb/p2.png)

### USB通信の仕方

#### USB機能の有効化

  1. main関数で、`USB_CDC_ini();`を呼び出します。
...
以上の設定がすでにされているMPLAB Xのプロジェクトファイルは[ここ](/images/2016-01-10-pic-usb/PIC18F27J53-USB_CDC-sample.zip)からダウンロードできます。
...
USBでシリアル通信ができるととても便利です。ぜひ使ってみてください！
