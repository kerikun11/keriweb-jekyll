...
以前にも
  ...
  * [C基板型ESP-WROOM-32ブレークアウト基板]({% post_url 2017-03-02-keriesp32 %})
  * [台形型ESP32-WROOM-32ブレークアウト基板]({% post_url 2017-07-23-keriesp32-trapezoid %})
...
![KERIESP32-Rectangle](keriesp32-rectangle.jpg){: .img-medium}
...
[![回路図](keriesp32-diagram.png)](keriesp32-diagram.png)
...
例によってKiCadで作成しました．配線は[自動配線]({% post_url 2016-04-22-freerouting %})です．

![配線パターン](keriesp32-pcb.png){: .img-medium}

![表面](3d-top.png){: .img-medium}

![裏面](3d-back.png){: .img-medium}
