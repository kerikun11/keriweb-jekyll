...
ブートローダを使う上での回路変更は特にありません。ただ、RC2(13 pin)がブートローダのステータスLEDをつけるといいでしょう。
...
[HID\_Bootloader\_PIC18F27J53(RB0-software-enter).hex](/images/2016-01-13-pic-bootloader/HID_Bootloader_PIC18F27J53(RB0-software-enter).hex)  
...
![ROM rages](/images/2016-01-13-pic-bootloader/Required_Application_Project_ROM_Ranges_Linker_Settings_for_XC8.png)
![Codeoffset](/images/2016-01-13-pic-bootloader/Required_Application_Project_Codeoffset_Linker_Settings_for_XC8.png)
...
PICをリセットしたときに、RB0端子がHIGHならばユーザープログラム、LOWならばブートローダプログラムが起動します。
...
![HIDbootloader.exe](/images/2016-01-13-pic-bootloader/util1.png)
